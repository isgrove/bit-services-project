                    ...
                    <div class="col-8">
                        <div class="row d-inline">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList CssClass="form-control" ID="ddlRequiredSkill" 
                                                      runat="server">
                                        <asp:ListItem Text="Select" Value="select" />
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="col">
                                <label>Job Description (Max 254 chars)</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control resize-none h-100" ID="txtDescription" runat="server"
                                                 placeholder="Job Description" Rows="3" TextMode="MultiLine"/>
                                </div>
                            </div>
                        </div>
                    </div>
